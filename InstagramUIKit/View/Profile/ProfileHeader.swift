...
class ProfileHeader: UICollectionReusableView {
    ...
    private let editProfileFollowButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(editProfileFollowTappedHandle), for: .touchUpInside)
        return button
    }()
    ...
    private lazy var postLabel: UILabel = {
       let label = UILabel()
        ...
        label.attributedText = atrributedStatText(value: 1, label: "post")
        return label
    }()
    ...
    private lazy var followerLabel: UILabel = {
       let label = UILabel()
        label.numberOfLines = 0
        label.textAlignment = .center
        label.attributedText = atrributedStatText(value: 1, label: "followers")
        return label
    }()
    ...
    private lazy var followingLabel: UILabel = {
       let label = UILabel()
        label.numberOfLines = 0
        label.textAlignment = .center
        label.attributedText = atrributedStatText(value: 1, label: "following")
        return label
    }()
    ...
    @objc func editProfileFollowTappedHandle(){
        myPrint("handle profile")
    }
